...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <h1 style="text-align:center;color:yellow">CORONARY HEART DISEASE DIAGNOSIS </h1>
    ...
    <div class="content">
        ...
        <table style =  border="0" bgcolor="#f2f2f2" align="center" "width:800px" margin-bottom:"300px">
            <tr>
                <td>
